...
public class ApitoolsTestContainer extends TestContainer {

    public ApitoolsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/xformix/apitools/app.properties",
    ...
    public static class Common extends ApitoolsTestContainer {

        public static final ApitoolsTestContainer.Common INSTANCE = new ApitoolsTestContainer.Common();
