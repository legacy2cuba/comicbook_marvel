...
public class ComicbookTestContainer extends TestContainer {

    public ComicbookTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/xformix/comicbook/app.properties",
    ...
    public static class Common extends ComicbookTestContainer {

        public static final ComicbookTestContainer.Common INSTANCE = new ComicbookTestContainer.Common();
